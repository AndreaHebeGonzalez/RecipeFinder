import { memo, useRef, useState, useEffect, ChangeEvent , Dispatch} from "react"
...
const RangeSliderComponent = ({ name, nameApi, min, max, step, values, onChange } : RangeSliderProps) => {
